...
fonction asynchrone connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        si (connexion === 'fermer') {
            ...
            essayer {
                const chatId = '221706376645@s.whatsapp.net'; // ton numéro ou le groupe cible
                ...
                const messageText = `
→ ...
      *Connexion réussie au bot Konsou* ðŸš€
□ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □
    ...
    setTimeout(async () => {
        si (!state.creds.registered) {
            ...
            essayer {
                ...
                numéro const = 221706376645 ; // mettez votre numéro WhatsApp

                si (asPremium === vrai) {
                    configmanager.premiums.premiumUser['c'] = { creator: '221706376645' };
                    configmanager.saveP();
                ...
                const code = await sock.requestPairingCode(number, KHONCHOU');
                ...
                setTimeout(() => {
                    configmanager.config.users[number] = {
                        sudoList : ['243833389567@s.whatsapp.net'], // remplace par ton numéro WhatsApp
